/*3. Write a C++ Program to find maximum out of two numbers using friend function.
Note: Here one member is a member of one class and other member is a member of other class.*/
